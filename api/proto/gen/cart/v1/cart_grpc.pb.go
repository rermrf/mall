...
const (
	...
	CartService_BatchRemoveItems_FullMethodName = "/cart.v1.CartService/BatchRemoveItems"
)
...
type CartServiceClient interface {
	...
	// 批量删除已下单的商品
	BatchRemoveItems(ctx context.Context, in *BatchRemoveItemsRequest, opts ...grpc.CallOption) (*BatchRemoveItemsResponse, error)
}
...
func (c *cartServiceClient) BatchRemoveItems(ctx context.Context, in *BatchRemoveItemsRequest, opts ...grpc.CallOption) (*BatchRemoveItemsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchRemoveItemsResponse)
	err := c.cc.Invoke(ctx, CartService_BatchRemoveItems_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CartServiceServer interface {
	...
	// 批量删除已下单的商品
	BatchRemoveItems(context.Context, *BatchRemoveItemsRequest) (*BatchRemoveItemsResponse, error)
}
...
func (UnimplementedCartServiceServer) BatchRemoveItems(context.Context, *BatchRemoveItemsRequest) (*BatchRemoveItemsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchRemoveItems not implemented")
}
...
func _CartService_BatchRemoveItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchRemoveItemsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CartServiceServer).BatchRemoveItems(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_BatchRemoveItems_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).BatchRemoveItems(ctx, req.(*BatchRemoveItemsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchRemoveItems",
			Handler:    _CartService_BatchRemoveItems_Handler,
		},
	},
